...
const hiddenElements = document.querySelectorAll(".hidden", ".hiddenlogin");
...
//Création des work de la modale
function createModalWork(i, data) {
  ...
  figurePhoto.classList.add('modalwork');
...
//Création de la preview dans le form d'ajout d'image
createImagePreview()
...
async function initApiEdition() {
  await fetch("http://localhost:5678/api/works")
    ...
    //Ecouteur des boutons supprimer
    .then(() => {
    ...
    //Ecouteur du submit pour l'ajout d'image
    .then(() => {
...
//Rafraichissement de la modale en gardant les boutons
